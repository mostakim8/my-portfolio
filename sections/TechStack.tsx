          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
            {TECH_DATA.map((tech, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group p-6 bg-slate-50 dark:bg-slate-900 border border-brand-light/20 rounded-3xl flex flex-col items-center justify-center text-center hover:shadow-xl transition-all duration-300"
              >
                <img
                  src={tech.icon}
                  alt={tech.name}
